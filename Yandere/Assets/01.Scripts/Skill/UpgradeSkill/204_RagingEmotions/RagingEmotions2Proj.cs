...
public class RagingEmotions2Proj : BaseProjectile
{
    ...
    public void Initialize(Transform player, float startAngle, RagingEmotions2Wrapper data, LayerMask enemyLayer)
    {
        _player = player;
