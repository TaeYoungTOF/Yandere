...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        Rect[] NSA_GalaxyZFold5 = new Rect[]
        {
            new Rect(0f, 80f / 2176f, 1f, (2176f - 160f) / 2176f), // 세로 모드 (상단/하단 여백 고려)
            new Rect(120f / 1812f, 0f, (1812f - 240f) / 1812f, 1f)  // 가로 모드 (좌우 여백 고려)
        };
            ...
            if (Application.isEditor && Sim != SimDevice.None)
            {
                ...
                switch (Sim)
                {
                    ...
                    case SimDevice.Pixel3XL_LSR:
                        ...
                        break;
                    case SimDevice.GalaxyZFold5:
                        if (Screen.height > Screen.width)  // Portrait
                            nsa = NSA_GalaxyZFold5[0];
                        else  // Landscape
                            nsa = NSA_GalaxyZFold5[1];
                        break;
                    default:
                        break;
                }
